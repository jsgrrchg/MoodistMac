...
enum L10n {
    ...
    static var mediaKeyNextMixFooter: String {
        tr(
    ...
    static func addToFavoritesLabel(_ name: String) -> String {
        String(format: tr("add_to_favorites_label", "Add %@ to favorites"), name)
    }
    static func removeFromFavoritesLabel(_ name: String) -> String {
    ...
    static var updateDownloadingTitle: String {
    ...
    static var updateNotesFailed: String {
        tr("update_notes_failed", "Could not load release notes.")
    }
    static var updatePermissionTitle: String {
    ...
    static var disableTransparencies: String {
        tr("disable_transparencies", "Disable transparencies")
    }
    static var disableTransparenciesFooter: String {
        tr(
    ...
    static var maxRecentMixesFooter: String {
    ...
    static var exportPreferencesHint: String {
        tr(
    ...
    static var exportFailedMessage: String {
    ...
    static var importPreferencesHint: String {
        tr(
    ...
    static var resetSelectionAndFavorites: String {
    ...
    static var askForNewSound: String {
    ...
    static var menuBarShowFooter: String {
    ...
    static var sidebarFavoriteMixesEmpty: String {
    ...
    static var resizeSidebarHint: String {
    ...
    static var clickToggleSelection: String {
