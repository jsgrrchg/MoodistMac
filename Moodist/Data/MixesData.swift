...
enum MixesData {
    ...
    static let natureRelaxation = MixCategory(
        ...
        mixes: [
            ...
            Mix(id: "cave-drip-meditation", name: "Cave Drip Meditation", iconName: "drop.fill", soundIds: ["sea-cave", "droplets", "underwater", "bubbles", "pink-noise"], volumes: ["sea-cave": v(60), "droplets": v(5), "underwater": v(20), "bubbles": v(12), "pink-noise": v(10)]),
            ...
            Mix(id: "rain-on-leaves-river", name: "Rain on Leaves, River Under", iconName: "leaf", soundIds: ["rain-on-leaves", "river", "wind-in-trees", "wind"], volumes: ["rain-on-leaves": v(100), "river": v(40), "wind-in-trees": v(30), "wind": v(10)]),
            Mix(id: "rainforest-shrine", name: "Rainforest Shrine", iconName: "leaf.fill", soundIds: ["rainforest", "wind-in-trees", "singing-bowl", "birds"], volumes: ["rainforest": v(55), "wind-in-trees": v(25), "singing-bowl": v(14), "birds": v(12)]),
            ...
            Mix(id: "river-meditation", name: "River Meditation", iconName: "waveform.path.ecg", soundIds: ["river", "pink-noise", "wind-chimes", "wind", "birds", "singing-bowl"], volumes: ["river": v(55), "pink-noise": v(30), "wind-chimes": v(15), "wind": v(10), "birds": v(10), "singing-bowl": v(15)]),
            Mix(id: "rockfall-river", name: "Rockfall River", iconName: "mountain.2.fill", soundIds: ["river", "rocks-falling", "wind-in-trees", "droplets"], volumes: ["river": v(50), "rocks-falling": v(50), "wind-in-trees": v(22), "droplets": v(15)]),
            Mix(id: "savanna-sunset", name: "Savanna Sunset", iconName: "sunset.fill", soundIds: ["wind", "crickets", "lion"], volumes: ["wind": v(40), "crickets": v(25), "lion": v(18)]),
    ...
    static let walking = MixCategory(
        ...
        mixes: [
            ...
            Mix(id: "gravel-miles", name: "Gravel Miles", iconName: "figure.walk", soundIds: ["walk-on-gravel", "road", "traffic", "wind"], volumes: ["walk-on-gravel": v(75), "road": v(75), "traffic": v(75), "wind": v(25)])
        ]
    )
    ...
    static let seaCoast = MixCategory(
        ...
        mixes: [
            Mix(id: "calm-beach", name: "Calm Beach", iconName: "sun.max.fill", soundIds: ["waves", "wind", "seagulls", "pink-noise"], volumes: ["waves": v(65), "wind": v(25), "seagulls": v(75), "pink-noise": v(10)]),
            ...
            Mix(id: "foghorn-bay", name: "Foghorn Bay", iconName: "speaker.wave.2.fill", soundIds: ["waves", "wind", "fog-horn", "seagulls"], volumes: ["waves": v(50), "wind": v(25), "fog-horn": v(100), "seagulls": v(60)]),
            ...
            Mix(id: "ocean-storm", name: "Ocean Storm", iconName: "cloud.bolt.rain.fill", soundIds: ["waves", "heavy-rain", "rain-on-window", "thunder", "wind", "pink-noise"], volumes: ["waves": v(55), "heavy-rain": v(45), "rain-on-window": v(25), "thunder": v(25), "wind": v(20), "pink-noise": v(25)]),
            Mix(id: "penguin-coast", name: "Penguin Coast", iconName: "bird.fill", soundIds: ["waves", "wind", "penguin", "sea-cave", "howling-wind"], volumes: ["waves": v(55), "wind": v(25), "penguin": v(15), "sea-cave": v(20), "howling-wind": v(40)]),
    ...
    static let forestFireNight = MixCategory(
        ...
        iconName: "flame.fill",
        mixes: [
            Mix(id: "cabin-creaks-fire", name: "Cabin Creaks & Fire", iconName: "house.fill", soundIds: ["campfire", "wind-in-trees", "wood-creak", "walking-on-wood", "clock"], volumes: ["campfire": v(100), "wind-in-trees": v(25), "wood-creak": v(12), "walking-on-wood": v(10), "clock": v(10)]),
            Mix(id: "crickets-breeze", name: "Crickets & Breeze", iconName: "moon.stars.fill", soundIds: ["crickets", "wind-in-trees", "wind", "pink-noise"], volumes: ["crickets": v(75), "wind-in-trees": v(25), "wind": v(0), "pink-noise": v(5)]),
            ...
            Mix(id: "fire-chimes", name: "Fire & Chimes", iconName: "bell.fill", soundIds: ["campfire", "wind-chimes", "wind-in-trees", "crickets", "pink-noise"], volumes: ["campfire": v(100), "wind-chimes": v(30), "wind-in-trees": v(25), "crickets": v(15), "pink-noise": v(10)]),
            Mix(id: "forest-cabin", name: "Forest Cabin", iconName: "house.fill", soundIds: ["rain-on-window", "campfire", "wind-in-trees", "wind", "pink-noise"], volumes: ["rain-on-window": v(75), "campfire": v(100), "wind-in-trees": v(35), "wind": v(20), "pink-noise": v(10)]),
            ...
            Mix(id: "night-camp", name: "Night Camp", iconName: "flame.fill", soundIds: ["campfire", "crickets", "wind-in-trees", "wind"], volumes: ["campfire": v(100), "crickets": v(62), "wind-in-trees": v(57), "wind": v(32)]),
            Mix(id: "night-river", name: "Night River", iconName: "moon.fill", soundIds: ["river", "crickets", "wind", "wind-in-trees", "pink-noise"], volumes: ["river": v(67), "crickets": v(50), "wind": v(37), "wind-in-trees": v(67), "pink-noise": v(10)]),
            Mix(id: "rainforest-night-camp", name: "Rainforest Night Camp", iconName: "flame.fill", soundIds: ["campfire", "rainforest", "crickets", "wind-in-trees", "owl"], volumes: ["campfire": v(100), "rainforest": v(35), "crickets": v(25), "wind-in-trees": v(20), "owl": v(12)]),
            Mix(id: "rockslide-camp", name: "Rockslide Camp", iconName: "flame.fill", soundIds: ["campfire", "wind-in-trees", "crickets", "rocks-falling"], volumes: ["campfire": v(100), "wind-in-trees": v(25), "crickets": v(30), "rocks-falling": v(25)]),
            Mix(id: "soft-campfire", name: "Soft Campfire", iconName: "flame", soundIds: ["campfire", "wind-in-trees", "crickets"], volumes: ["campfire": v(100), "wind-in-trees": v(22), "crickets": v(77)]),
            Mix(id: "storm-camp", name: "Storm Camp", iconName: "cloud.bolt.rain.fill", soundIds: ["heavy-rain", "campfire", "rain-on-window", "thunder", "wind-in-trees"], volumes: ["heavy-rain": v(35), "campfire": v(100), "rain-on-window": v(12), "thunder": v(87), "wind-in-trees": v(32)])
        ]
    )
    ...
    static let rainStorm = MixCategory(
        ...
        mixes: [
            Mix(id: "car-roof-commute", name: "Car Roof Commute", iconName: "car.fill", soundIds: ["rain-on-car-roof", "windshield-wipers", "traffic", "thunder"], volumes: ["rain-on-car-roof": v(55), "windshield-wipers": v(100), "traffic": v(100), "thunder": v(10)]),
            Mix(id: "cathedral-drizzle", name: "Cathedral Drizzle", iconName: "building.columns.fill", soundIds: ["church", "rain-on-window", "light-rain", "singing-bowl"], volumes: ["church": v(100), "rain-on-window": v(7), "light-rain": v(10), "singing-bowl": v(10)]),
            ...
            Mix(id: "kitchen-rain-boil", name: "Kitchen Rain Boil", iconName: "fork.knife", soundIds: ["chinese-kitchen", "boiling-water", "rain-on-window", "droplets"], volumes: ["chinese-kitchen": v(35), "boiling-water": v(20), "rain-on-window": v(15), "droplets": v(5)]),
            ...
            Mix(id: "subway-downpour", name: "Subway Downpour", iconName: "cloud.rain.fill", soundIds: ["subway-station", "rain-on-window", "rain-on-umbrella", "crowd", "wind"], volumes: ["subway-station": v(100), "rain-on-window": v(10), "rain-on-umbrella": v(100), "crowd": v(20), "wind": v(40)]),
            Mix(id: "tentstorm-shelter", name: "Tentstorm Shelter", iconName: "tent.fill", soundIds: ["rain-on-tent", "howling-wind", "heavy-rain", "thunder", "wolf"], volumes: ["rain-on-tent": v(100), "howling-wind": v(30), "heavy-rain": v(25), "thunder": v(65), "wolf": v(40)]),
            Mix(id: "umbrella-bells", name: "Umbrella Bells", iconName: "umbrella.fill", soundIds: ["rain-on-umbrella", "droplets", "wind", "bells"], volumes: ["rain-on-umbrella": v(55), "droplets": v(20), "wind": v(35), "bells": v(12)])
        ]
    )
    ...
    static let focusStudy = MixCategory(
        ...
        iconName: "book.fill",
        mixes: [
            Mix(id: "analog-writing", name: "Analog Writing", iconName: "pencil.and.outline", soundIds: ["typewriter", "vinyl-effect", "clock", "tuning-radio"], volumes: ["typewriter": v(100), "vinyl-effect": v(25), "clock": v(12), "tuning-radio": v(10)]),
            ...
            Mix(id: "focused-writing", name: "Focused Writing", iconName: "pencil.and.outline", soundIds: ["clock", "library"], volumes: ["clock": v(25), "library": v(100)]),
            ...
            Mix(id: "printer-focus", name: "Printer Focus", iconName: "printer.fill", soundIds: ["office", "keyboard", "mouse-clicking", "printer", "clock"], volumes: ["office": v(100), "keyboard": v(35), "mouse-clicking": v(20), "printer": v(18), "clock": v(12)]),
            Mix(id: "productive-cafe", name: "Productive Cafe", iconName: "cup.and.saucer.fill", soundIds: ["cafe", "light-rain", "pink-noise"], volumes: ["cafe": v(100), "light-rain": v(22), "pink-noise": v(22)]),
            ...
            Mix(id: "trading-floor-terminal", name: "Trading Floor Terminal", iconName: "chart.line.uptrend.xyaxis", soundIds: ["trading-floor", "crowd", "keyboard", "printer", "cash-register"], volumes: ["trading-floor": v(100), "crowd": v(100), "keyboard": v(20), "printer": v(12), "cash-register": v(10)])
        ]
    )
    ...
    static let travelMotion = MixCategory(
        ...
        mixes: [
            ...
            Mix(id: "beach-ride", name: "Beach Ride", iconName: "sun.max.fill", soundIds: ["waves", "horse-gallop", "wind", "seagulls", "pink-noise"], volumes: ["waves": v(60), "horse-gallop": v(45), "wind": v(25), "seagulls": v(30), "pink-noise": v(15)]),
            Mix(id: "cafe-commute", name: "Cafe Commute", iconName: "cup.and.saucer.fill", soundIds: ["inside-a-train", "cafe", "rain-on-window", "pink-noise"], volumes: ["inside-a-train": v(100), "cafe": v(100), "rain-on-window": v(10), "pink-noise": v(10)]),
            Mix(id: "city-bike-rush", name: "City Bike Rush", iconName: "bicycle", soundIds: ["bike-ride", "busy-street", "traffic", "crowd"], volumes: ["bike-ride": v(100), "busy-street": v(30), "traffic": v(25), "crowd": v(15)]),
            Mix(id: "coastal-ride", name: "Coastal Ride", iconName: "water.waves", soundIds: ["inside-a-train", "waves", "seagulls", "wind", "rain-on-window"], volumes: ["inside-a-train": v(100), "waves": v(60), "seagulls": v(30), "wind": v(20), "rain-on-window": v(10)]),
            Mix(id: "diesel-yard-shift", name: "Diesel Yard Shift", iconName: "truck.box.fill", soundIds: ["construction-site", "road", "diesel-fork-lift", "dumper-truck", "wind"], volumes: ["construction-site": v(80), "road": v(25), "diesel-fork-lift": v(18), "dumper-truck": v(18), "wind": v(15)]),
            ...
            Mix(id: "night-train", name: "Night Train", iconName: "moon.fill", soundIds: ["inside-a-train", "pink-noise", "rain-on-window", "wind"], volumes: ["inside-a-train": v(100), "pink-noise": v(5), "rain-on-window": v(62), "wind": v(22)]),
            Mix(id: "quiet-carriage", name: "Quiet Carriage", iconName: "speaker.slash.fill", soundIds: ["inside-a-train", "rain-on-window"], volumes: ["inside-a-train": v(100), "rain-on-window": v(33)]),
            Mix(id: "rowing-at-dawn", name: "Rowing at Dawn", iconName: "sunrise", soundIds: ["rowing-boat", "river", "seagulls", "wind", "droplets"], volumes: ["rowing-boat": v(80), "river": v(40), "seagulls": v(20), "wind": v(15), "droplets": v(10)]),
            ...
            Mix(id: "storm-ride", name: "Storm Ride", iconName: "cloud.bolt.rain.fill", soundIds: ["heavy-rain", "horse-gallop", "wind", "thunder", "rain-on-leaves"], volumes: ["heavy-rain": v(50), "horse-gallop": v(35), "wind": v(30), "thunder": v(65), "rain-on-leaves": v(15)]),
            Mix(id: "submarine-cave-drift", name: "Submarine Cave Drift", iconName: "water.waves", soundIds: ["submarine", "sea-cave", "underwater", "bubbles"], volumes: ["submarine": v(40), "sea-cave": v(100), "underwater": v(30), "bubbles": v(12)]),
            ...
            Mix(id: "subway-umbrella-rush", name: "Subway Umbrella Rush", iconName: "tram.fill", soundIds: ["subway-station", "rain-on-umbrella", "busy-street", "traffic", "wind"], volumes: ["subway-station": v(100), "rain-on-umbrella": v(42), "busy-street": v(62), "traffic": v(72), "wind": v(22)]),
            Mix(id: "train-journey", name: "Train Journey", iconName: "tram.fill", soundIds: ["inside-a-train", "rain-on-window", "wind"], volumes: ["inside-a-train": v(100), "rain-on-window": v(47), "wind": v(47)]),
    ...
    static let sleepNoise = MixCategory(
        ...
        mixes: [
            ...
            Mix(id: "snore-brown-shield", name: "Snore Brown Shield", iconName: "waveform", soundIds: ["brown-noise", "ceiling-fan", "men-snoring"], volumes: ["brown-noise": v(55), "ceiling-fan": v(25), "men-snoring": v(80)]),
            ...
            Mix(id: "window-night", name: "Window Night", iconName: "window.ceiling", soundIds: ["rain-on-window", "pink-noise", "wind", "crickets", "thunder"], volumes: ["rain-on-window": v(65), "pink-noise": v(35), "wind": v(10), "crickets": v(10), "thunder": v(25)])
        ]
    )
    ...
    static let placesAmbience = MixCategory(
        ...
        mixes: [
            ...
            Mix(id: "flea-market-morning", name: "Flea Market Morning", iconName: "cart.fill", soundIds: ["flea-market", "crowd", "cash-register", "road", "birds"], volumes: ["flea-market": v(100), "crowd": v(25), "cash-register": v(15), "road": v(15), "birds": v(10)]),
            ...
            Mix(id: "owl-at-the-temple", name: "Owl at the Temple", iconName: "moon.stars.fill", soundIds: ["temple", "owl", "wind-in-trees", "singing-bowl", "droplets"], volumes: ["temple": v(100), "owl": v(30), "wind-in-trees": v(30), "singing-bowl": v(20), "droplets": v(10)]),
            ...
            Mix(id: "quiet-kitchen-night", name: "Quiet Kitchen Night", iconName: "fork.knife", soundIds: ["restaurant", "chinese-kitchen", "boiling-water", "cash-register", "crowd"], volumes: ["restaurant": v(70), "chinese-kitchen": v(25), "boiling-water": v(20), "cash-register": v(12), "crowd": v(12)]),
